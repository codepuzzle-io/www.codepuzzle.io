	...
	<div class="container mt-3 mb-5">
		...
		<div class="row">
            ...
            <div class="col-md-2">
                ...
                <div class="mb-1 text-center" style="opacity:1.0"><a class="btn btn-light btn-sm d-block" href="{{route('console-puzzles')}}" role="button">{{__('PUZZLES')}}</a></div>
                    ...
                    <div id="frame_{{$loop->iteration}}" class="frame">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 text-monospace text-muted">
    							...
    							<div style="float:right;">
                                    ...
                                    <span id="supprimer_confirm_{{$loop->iteration}}" style="display:none">
                                        <div id="supprimer_{{$loop->iteration}}" class="d-inline-block">
                                            <a href='/console/puzzle-supprimer/{{ Crypt::encryptString($puzzle->id) }}' class='btn btn-danger btn-sm text-light ml-3' role='button'  style="cursor:pointer;outline:none;" data-toggle="tooltip" data-placement="top" title="{{__('supprimer')}}"><i class='fas fa-trash fa-sm'></i></a>
                                        </div>
                                ...
                                @if ($puzzle->sous_titre_enseignant !== NULL)
...
IFrame('https://www.codepuzzle.io/IP{{ strtoupper($puzzle->jeton) }}', width='100%', height=600)</textarea>
                                    ...
                                    @if ($puzzle->titre_eleve !== NULL OR $puzzle->consignes_eleve !== NULL)
                                        @if ($puzzle->titre_eleve !== NULL)
                                            <div class="mt-3 text-monospace small">{{ strtoupper($puzzle->titre_eleve) }}</div>
                                        @else
                                    ...
                                    <div class="mt-3 text-monospace small">{{__('FAUX CODE')}}</div>
