                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 text-monospace text-muted">
    							...
    							<div style="float:right;">
    								...
    								<a class='btn btn-light btn-sm' href='/console/defi-modifier/{{ Crypt::encryptString($defi->id) }}' role='button'><i class="fas fa-pen" data-toggle="tooltip" data-placement="top" title="{{__('modifier')}}"></i></a>
